document.querySelector(".sliderFirst") &&
  ...
  document.querySelector(".sliderTestimonialFourth") &&
    tns({
      ...
      responsive: { 768: { items: 2 }, 990: { items: 1 }, 1400: { items: 2 } },
    }),
  document.querySelector(".dashboard-slider") &&
    tns({
      loop: !0,
      startIndex: 1,
      items: 1,
      ...
      gutter: 20,
      controls: !1,
      responsive: { 768: { items: 2 }, 990: { items: 1 } },
    });
